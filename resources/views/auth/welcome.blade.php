...
<style>
    ...
    .scroll-container::-webkit-scrollbar {
        ...
        /* Buat transparan saat tidak di-hover */
    }

    /* Ubah warna scrollbar track saat di-hover */
    .scroll-container:hover::-webkit-scrollbar {
        background-color: #ddd;
        /* Track scrollbar saat di-hover */
    }
    ...
    .scroll-container:hover::-webkit-scrollbar-thumb {
        ...
        /* Warna thumb scrollbar saat di-hover */
        border-radius: 4px;
    }
...
<body>
    ...
    <div class="up container-fluid" id="up">
        <nav class="navbar navbar-expand-lg ms-5 me-5 "
            style="background-color: #ffffff71; border-radius: 40px; top: 20px; position: fixed; width: 90%; z-index: 10;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-lg-0 fw-bold ms-5" style="gap: 20px;">
                        ...
                        <li class="nav-item" style="margin-left: 14rem;">
                            <a class="sigin nav-link ps-5 pe-5" style=" border-radius: 20px;" href="login.html"">Sig
                                In</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 mt-3">
                <div class="lefet" style="position: absolute;">
                    <h2 class="fw-bold" style="margin: 200px 0px 0px 120px; color: #082D33; width: 340px;">Temukan
                        Peluang PKL yang tepat untuk mu di Sini</h2>
                    <p style="width: 300px; margin: 12px 0px 0px 120px;">Membantu siswa untuk menemukan tempat<b> PKL
                        </b>yang sesuai dengan jurusan dan keahlian.</p>
                    <a href="" class="btn text-white ps-3 pe-3 mt-2"
                        style="background-color: #0E939A; border-radius: 20px; margin-left: 120px;">Temukan
                        Sekarang!!</a>
                </div>
            </div>
            <div class="col-md-6">
                <img src="img/laptop.png" width="450px"
                    style="position: absolute; z-index: 1; top: 160px; margin-left: 100px;" h alt="">
            </div>
        </div>
    </div>
    <div class="container pb-5" id="about">
        <div class="about pt-5">
            ...
            <p class="text-center mt-5">
                About Us Selamat datang di <b>PKLzone</b>, website yang diperuntukan bagi siswa menemukan tempat PKL
                yang sesuai dengan jurusan dan kemampuan yang dimiliki oleh siswa, serta membantu perusahaan dalam
                menemukan bakat - bakat baru yang siap berkontribusi.
            </p>
    ...
    <div class="container-fluid pb-5" id="contact">
        <div class="contact">
            <div class="text pt-5 pb-5" style="background-color: #6799B4;">
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: -60px 0px 0px 100px;">
                    <>
                </p>
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: 20px 0px 0px 900px;">
                    <>
                </p>
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: -80px 0px 0px 700px;">
                    <>
                </p>
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: 60px 0px 0px 500px;">
                    <>
                </p>
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: -50px 0px 0px 1200px;">
                    <>
                </p>
                <p class="fw-bold fs-1 text-white" style="position: absolute; margin: 0px 0px 0px 200px;">
                    <>
                </p>
                ...
                <div class="row g-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="email"
                                                    style="background-color: #ddd; border-radius: 40px;"
                                                    class="form-control border-0 p-3" name=""
                                            ...
                                            <div class="col-md-6">
                                                <input type="number"
                                                    style="background-color: #ddd; border-radius: 40px;"
                                                    class="form-control border-0 p-3" name=""
                                                    placeholder="No Handphone" id="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-4">
                                        <input type="text" style="background-color: #ddd; border-radius: 40px;"
                                            class="form-control border-0 p-3" name="" placeholder="Name"
                                            id="">
                                    </div>
                                    <div class="col-md-12 mt-4">
                                        <textarea name="" id="" rows="5" style="background-color: #ddd; border-radius: 40px;"
                                            class="form-control border-0 p-3 " placeholder="Mesage"></textarea>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-dark w-25 mt-5"
                                    style="border-radius: 40px; background-color: #082D33;">Send</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="newsletter-box">
                            ...
                            <form>
                                <div class="mb-3">
                                    <input type="email" style="background-color: #ddd; border-radius: 40px;"
                                        class="form-control border-0 p-3" id="newsletter-email" placeholder="Email">
                                </div>
