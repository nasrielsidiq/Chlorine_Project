        ...
        <div class="navbar-custom-menu w-100">
            <ul class="nav navbar-nav d-flex w-100 align-items-center">
                ...
                <li class="pt-15 d-flex" >
                    <a href="/admin/teacher" class="ml-3 fw-bold"  style="text-decoration:none ; color : #294D61"><i class="fi fi-rr-angle-left fs-3 fw-bold"></i></a> <!-- Margin left for left spacing -->
            ...
            <div class="container" >
                <div class="content w-100">
                    <div class="profile p-5  bg-white" style="border-radius: 50px;" >
                        <form action="/admin/add/user/teacher" class="p-3 pt-5" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input class="form-control mt-2 border-0 pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" type="text" name="username" id="nisn">
                                        </div>
