        ...
        <div class="navbar-custom-menu w-100">
            <ul class="nav navbar-nav d-flex w-100 align-items-center">
                ...
                <li class="pt-15 d-flex" >
                    <a href="/admin/industry" class="ml-3 fw-bold"  style="text-decoration:none ; color : #294D61"><i class="fi fi-rr-angle-left fs-3 fw-bold"></i></a> <!-- Margin left for left spacing -->
                    <h3 class="ml-3 fw-bold">Create Industry</h3> <!-- Margin left for left spacing -->
                </li>
            ...
            <div class="container" >
                <div class="content w-100">
                    <div class="profile p-5  bg-white" style="border-radius: 50px;" >
                        <form action="/admin/add/user/industry" class="p-3 pt-5" method="post">
                            @csrf
                            <div class="row">
