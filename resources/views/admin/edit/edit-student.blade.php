        ...
        <div class="navbar-custom-menu w-100">
            <ul class="nav navbar-nav d-flex w-100 align-items-center">
                ...
                <li class="pt-15 d-flex" >
                    ...
                    <h3 class="ml-3 fw-bold">Edit Student</h3> <!-- Margin left for left spacing -->
                </li>
                        ...
                        <form action="" class="p-3 pt-5" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <input class="form-control mt-2 border-0 pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" type="number" name="npsn" id="nisn">
                                </div>
                                <div class="col-md-12 mt-3">
