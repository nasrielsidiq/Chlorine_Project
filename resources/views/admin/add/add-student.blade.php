        ...
        <div class="navbar-custom-menu w-100">
            <ul class="nav navbar-nav d-flex w-100 align-items-center">
                ...
                <li class="pt-15 d-flex" >
                    <a href="/student-page" class="ml-3 fw-bold"  style="text-decoration:none ; color : #294D61"><i class="fi fi-rr-angle-left fs-3 fw-bold"></i></a> <!-- Margin left for left spacing -->
            ...
            <div class="container" >
                <div class="content w-100">
                    <div class="profile p-5  bg-white" style="border-radius: 50px;" >
                        <form action="/admin/add/profile/student/{{ $id }}" class="p-3 pt-5" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-10">
                                            <label for="nisn" class="ms-2">NISN</label>
                                            <input class="form-control mt-2 border-0 pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" type="number" name="nisn" id="nisn">
                                        </div>
                                ...
                                <div class="col-md-12" style="margin-top:-30px ;">
                                    ...
                                    <input type="text" class="form-control mt-2 border-0 pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6; " name="name" id="nama">
                                </div>
                                <div class="col-md-12 mt-3">
                                    <label for="npsn" class="ms-2">NPSN</label>
                                    <input class="form-control mt-2 border-0 pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" type="number" name="npsn" id="npsn">
                                </div>
                                <div class="col-md-12 mt-3">
                                    <label for="alamat" class="ms-2">Alamat</label>
                                    <textarea name="alamat" class="form-control mt-2 border-0" style="border-radius: 12px; background-color: #F6F6F6;" id="alamat" rows="4"></textarea>
                                </div>
                                <div class="col-md-12 mt-3" >
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="tgl" class="ms-2">Tanggal Lahir</label>
                                            <input type="date" class="form-control mt-2 border-0  pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" name="" id="tgl">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="jrs" class="ms-2">Jurusan</label>
                                            <input type="text" class="form-control mt-2 border-0  pt-2 pb-2" style="border-radius: 12px; background-color: #F6F6F6;" name="" id="jrs">
