    ...
    <nav class="navbar navbar-static-top bg-white pl-30"
        ...
        <div class="navbar-custom-menu w-100">
            <ul class="nav navbar-nav d-flex w-100 align-items-center">
                ...
                <li class="pt-15">
                    <h3 class="ml-3 fw-bold">School</h3> <!-- Margin left for left spacing -->
                </li>
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border d-flex justify-content-between align-items-center">
                            <h3 class="box-title" style="color: #082D33">Data Schools</h3>
                            <a href="/admin/add/user/school" class="fs-5" style="color: #082D33; text-decoration: none;">Add School <i class="fi fi-rr-add"></i></a> <!-- Aligning Data Sekolah and Add Sekolah in one line -->
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
